          ...
          <AnimatePresence>
            {filteredItems.map((item) => (
              <motion.div
                ...
                className="bg-card rounded-xl overflow-hidden border border-border/50 group cursor-pointer hover:border-primary/20 hover:shadow-[0_8px_30px_-10px_rgba(30,58,138,0.12)] hover:-translate-y-1"
